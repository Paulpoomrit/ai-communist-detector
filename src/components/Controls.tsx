...
const Controls = () => {
  ...
  const playClickSound = useCallback(() => {
    if (!isMuted) {
      const audio = new Audio("https://www.fesliyanstudios.com/play-mp3/641");
  ...
  const handleStartClick = () => {
    playClickSound();
    // Add any other start functionality here
  };

  const handleResultClick = () => {
    playClickSound();
    // Add any other result functionality here
  };
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center p-6 space-y-8 md:space-y-10 md:scale-75 lg:scale-75 xl:scale-75 transform-gpu">
      ...
      <div className="w-[50%] max-w-xl px-4">
