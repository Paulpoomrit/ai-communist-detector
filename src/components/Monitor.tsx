...
const Monitor = () => {
  return (
    <div className="relative w-full max-w-[810px] aspect-[810/720] mx-auto">
      <div 
        className="relative w-full h-full bg-contain bg-no-repeat bg-center z-10"
      ...
      >
        ...
        <div 
          className="absolute top-[10%] left-[9%] w-[82%] h-[63.5%] rounded bg-[#1903bd] flex items-center justify-center overflow-y-auto -z-10"
        >
